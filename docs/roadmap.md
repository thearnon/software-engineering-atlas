...
- Thai RBAC article has been expanded into the first primary topic layout reference
- RBAC content now includes definition, enterprise context, core components, a credit limit request case, related-topic comparison, common mistakes, checklist, and viewer handoff
- English RBAC content still exists as a concise localized article and can be expanded later using the same layout
- `docs/content-model.md` now documents this primary topic layout for future SEA topics
